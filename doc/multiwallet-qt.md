...
Only requiring some minor changes is people.cpp.
...
Changes to people.cpp
----------------------
people.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
