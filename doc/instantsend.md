...
This mechanism has been integrated into Bitcore-Node-People which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/peopleproject/insight-api-people#web-socket-api](https://github.com/peopleproject/insight-api-people#web-socket-api)
* API: [https://github.com/peopleproject/insight-api-people#instantsend-transactions](https://github.com/peopleproject/insight-api-people#instantsend-transactions)
...
By default, the People Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the People Core daemon:
