    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("People Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a People address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and people: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About People Core"), this);
    aboutAction->setStatusTip(tr("Show information about People Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for People Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your People addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified People addresses"));
    ...
    openAction->setStatusTip(tr("Open a people: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the People Core help message to get a list with possible People Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("People Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to People network", "", count));
    } else {
...
{
    QString strTitle = tr("People Core"); // default title
