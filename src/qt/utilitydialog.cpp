    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("People Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About People Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  people-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the People in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MEN, 0.1 MEN, 1 MEN and 10 MEN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://PeopleDev.atlassian.net/wiki/display/DOC/PrivateSend\">https://PeopleDev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("People Core is shutting down...") + "<br /><br />" +
