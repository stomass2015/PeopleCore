    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MEN-light"), QVariant("light"));
    ui->theme->addItem(QString("MEN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MEN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MEN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MEN-traditional"), QVariant("trad"));
