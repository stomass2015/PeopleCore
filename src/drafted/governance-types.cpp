...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PeopleNetwork") type = PeopleNetwork;
    if(strType == "PeopleNetworkVariable") type = PeopleNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PeopleNetwork) s = "PeopleNetwork";
    if(type == PeopleNetworkVariable) s = "PeopleNetworkVariable";
