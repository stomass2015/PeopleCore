 ...
 *
 *   // network
 *   CPeopleNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.people.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPeopleNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PeopleNetwork
// //   -- signature requirements : Key1(User)
// class CPeopleNetworkVariable : public CGovernanceObject
// {
// private:
