...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all People related functionality
...
/*
    ...
    allow endless transaction that would bloat People and make it unusable. To
